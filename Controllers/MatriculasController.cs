...
namespace RegistroEstudiantil.Controllers
{
    public class MatriculasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Matriculas.Include(m => m.Estudiante).Include(m => m.Materia);
        ...
        public async Task<IActionResult> Create([Bind("Id,Semestre,FechaMatricula,EstudianteId,MateriaId")] Matricula matricula)
        {
            ...
            ViewData["MateriaId"] = new SelectList(_context.Materias, "Id", "CodigoMateria", matricula.MateriaId);
            return View(matricula);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Semestre,FechaMatricula,EstudianteId,MateriaId")] Matricula matricula)
        {
            if (id != matricula.Id)
            {
                return NotFound();
